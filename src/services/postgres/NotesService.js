...
class NotesService {
  ...
  async addNote({
    ...
    // untuk menghapus cache yg disimpan ketika terjadi perubahan data
  ...
  // verifyNoteAccess mengandalkan fungsi verifyCollaborator
  // yang dimiliki oleh CollaborationsService

  // verifyNoteAccess memiliki fungsi untuk memverifikasi hak akses pengguna
